...
return [
    ...
    */
    ...
    'user' => [
        ...
        // However make sure the appointed class must ready to use before installing versatile.
        // Otherwise `php artisan versatile:install` will fail with class not found error.
        'namespace'                    => null,
