...
use Versatile\Core\Exceptions\InvalidJsonException;
...
class Json
{
    ...
    public function getAttributes()
    {
        ...
        if (config('versatile.modules.cache.enabled') === false) {
            return $attributes;
        }

        return app('cache')->remember($this->getPath(), config('versatile.modules.cache.lifetime'), function () use ($attributes) {
            return $attributes;
        });
    }
