...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'versatile:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Versatile.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/versatilecms/core/src/Http/Controllers'));
        $namespace = config('versatile.controllers.namespace', 'Versatile\\Core\\Http\\Controllers');
        ...
        $this->info('Published Versatile controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/versatilecms/core/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'Versatile\\Core\\Http\\Controllers\\'.$class,
            $content
        );
