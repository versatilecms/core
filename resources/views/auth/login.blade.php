    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <p>{{ __('versatile::auth.signin_below') }}</p>

                <form action="{{ route('versatile.login') }}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="versatile-refresh"></span> {{ __('versatile::auth.loggingin') }}...</span>
                        <span class="signin">{{ __('versatile::generic.login') }}</span>
                    </button>
              ...
              @endif
                ...
                <p><a href="{{route('versatile.password.request')}}">{{  __('versatile::auth.forgotten_password') }}</a></p>
