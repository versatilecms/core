...
<div class="row row-dd row-dd-relationship">
    <div class="col-xs-2">
        <h4><i class="versatile-heart"></i><strong>{{ $relationship->display_name }}</strong></h4>
        <div class="handler versatile-handle"></div>
        <strong>{{ __('versatile::database.type') }}:</strong> <span>{{ __('versatile::database.relationship.relationship') }}</span>
        <div class="handler versatile-handle"></div>
    ...
    <div class="col-xs-2">
        ...
        <label for="field_browse_{{ $relationship['field'] }}"> {{ __('versatile::database.relationship.browse') }}</label><br>
        ...
        <label for="field_read_{{ $relationship['field'] }}"> {{ __('versatile::database.relationship.read') }}</label><br>
        ...
        <label for="field_edit_{{ $relationship['field'] }}"> {{ __('versatile::database.relationship.edit') }}</label><br>
        ...
        <label for="field_add_{{ $relationship['field'] }}"> {{ __('versatile::database.relationship.add') }}</label><br>
        ...
        <label for="field_delete_{{ $relationship['field'] }}"> {{ __('versatile::database.relationship.delete') }}</label><br>

        <input type="checkbox" name="field_filter_{{ $relationship['field'] }}" @if(isset($relationship->filter) && $relationship->filter){{ 'checked="checked"' }}@elseif(!isset($relationship->filter)){{ 'checked="checked"' }}@endif>
        <label for="field_filter_{{ $relationship['field'] }}"> {{ __('versatile::generic.filter') }}</label><br>
    </div>
    <div class="col-xs-2">
        <p>{{ __('versatile::database.relationship.relationship') }}</p>
    </div>
    <div class="col-xs-2">
    ...
    <div class="col-xs-4">
        <div class="versatile-relationship-details-btn">
            <i class="versatile-angle-down"></i><i class="versatile-angle-up"></i> 
            <span class="open_text">{{ __('versatile::database.relationship.open') }}</span>
            <span class="close_text">{{ __('versatile::database.relationship.close') }}</span>
            {{ __('versatile::database.relationship.relationship_details') }}
        </div>
    </div>
    <div class="col-md-12 versatile-relationship-details">
        <a href="{{ route('versatile.bread.delete_relationship', $relationship['id']) }}" class="delete_relationship"><i class="versatile-trash"></i> {{ __('versatile::database.relationship.delete') }}</a>
        <div class="relationship_details_content">
            ...
            <select class="relationship_type select2" name="relationship_type_{{ $relationship['field'] }}">
                <option value="hasOne" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'hasOne'){{ 'selected="selected"' }}@endif>{{ __('versatile::database.relationship.has_one') }}</option>
                <option value="hasMany" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'hasMany'){{ 'selected="selected"' }}@endif>{{ __('versatile::database.relationship.has_many') }}</option>
                <option value="belongsTo" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'belongsTo'){{ 'selected="selected"' }}@endif>{{ __('versatile::database.relationship.belongs_to') }}</option>
                <option value="belongsToMany" @if(isset($relationshipDetails->type) && $relationshipDetails->type == 'belongsToMany'){{ 'selected="selected"' }}@endif>{{ __('versatile::database.relationship.belongs_to_many') }}</option>
            </select>
            ...
            <span><input type="text" class="form-control" name="relationship_model_{{ $relationship['field'] }}" placeholder="{{ __('versatile::database.relationship.namespace') }}" value="@if(isset($relationshipDetails->model)){{ $relationshipDetails->model }}@endif"></span>
        </div>
            <div class="relationshipField">
                <div class="relationship_details_content margin_top belongsTo @if($relationshipDetails->type == 'belongsTo'){{ 'flexed' }}@endif">
                    <label>{{ __('versatile::database.relationship.which_column_from') }} <span>{{ str_singular(ucfirst($table)) }}</span> {{ __('versatile::database.relationship.is_used_to_reference') }} <span class="label_table_name"></span>?</label>
                ...
                <div class="relationship_details_content margin_top hasOneMany @if($relationshipDetails->type == 'hasOne' || $relationshipDetails->type == 'hasMany'){{ 'flexed' }}@endif">
                    <label>{{ __('versatile::database.relationship.which_column_from') }} <span class="label_table_name"></span> {{ __('versatile::database.relationship.is_used_to_reference') }} <span>{{ str_singular(ucfirst($table)) }}</span>?</label>
        ...
        <div class="relationship_details_content margin_top relationshipPivot @if($relationshipDetails->type == 'belongsToMany'){{ 'visible' }}@endif">
            <label>{{ __('versatile::database.relationship.pivot_table') }}:</label>
        ...
        <div class="relationship_details_content margin_top">
            <label>{{ __('versatile::database.relationship.display_the') }} <span class="label_table_name"></span></label>
            ...
            <label class="relationship_key" style="@if($relationshipDetails->type == 'belongsTo' || $relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">{{ __('versatile::database.relationship.store_the') }} <span class="label_table_name"></span></label>
            ...
            @isset($relationshipDetails->taggable)
                <label class="relationship_taggable" style="@if($relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">
                    {{__('versatile::database.relationship.allow_tagging')}}
                </label>
                <span class="relationship_taggable" style="@if($relationshipDetails->type == 'belongsToMany'){{ 'display:block' }}@endif">
                    <input type="checkbox" name="relationship_taggable_{{ $relationship['field'] }}" class="toggleswitch" data-on="{{ __('versatile::generic.yes') }}" data-off="{{ __('versatile::generic.no') }}" {{$relationshipDetails->taggable == 'on' ? 'checked' : ''}}>
                </span>
            @endisset
        </div>
    </div>
