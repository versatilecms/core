...
@section('page_title', __('versatile::bread.edit_bread_for_table', ['table' => (isset($dataType->id) ? @$dataType->name : $table)]))

@section('page_header')
    <div class="page-title">
        <i class="versatile-data"></i>
        {{ __('versatile::bread.edit_bread_for_table', ['table' => (isset($dataType->id) ? @$dataType->name : $table)]) }}
    </div>
    @php
...
@section('content')
    <div class="page-content container-fluid" id="versatileBreadEditAdd">
        <div class="row">
            <div class="col-md-12">

                <form action="@if(isset($dataType->id)){{ route('versatile.bread.update', $dataType->id) }}@else{{ route('versatile.bread.store') }}@endif"
                ...
                @endif
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="versatile-bread"></i> {{ ucfirst($table) }} {{ __('versatile::bread.bread_info') }}</h3>
                            <div class="panel-actions">
                                <a class="panel-action versatile-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="name">{{ __('versatile::database.table_name') }}</label>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="display_name_singular">{{ __('versatile::bread.display_name_singular') }}</label>
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('versatile::bread.display_name_singular') }}"
                                           value="@if(isset($dataType->display_name_singular)){{ $dataType->display_name_singular }}@else{{ $display_name }}@endif">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="display_name_plural">{{ __('versatile::bread.display_name_plural') }}</label>
                                    @if($isModelTranslatable)
                                        @include('versatile::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('versatile::bread.display_name_plural') }}"
                                           value="@if(isset($dataType->display_name_plural)){{ $dataType->display_name_plural }}@else{{ $display_name_plural }}@endif">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="slug">{{ __('versatile::bread.url_slug') }}</label>
                                    <input type="text" class="form-control" name="slug" placeholder="{{ __('versatile::bread.url_slug_ph') }}"
                                           value="@if(isset($dataType->slug)){{ $dataType->slug }}@else{{ $slug }}@endif">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="icon">{{ __('versatile::bread.icon_hint') }} <a
                                                href="{{ route('versatile.compass.index', [], false) }}#fonts"
                                                target="_blank">{{ __('versatile::bread.icon_hint2') }}</a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="{{ __('versatile::bread.icon_class') }}"
                                           value="@if(isset($dataType->icon)){{ $dataType->icon }}@endif">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="model_name">{{ __('versatile::bread.model_name') }}</label>
                                    <span class="versatile-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('versatile::bread.model_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="{{ __('versatile::bread.model_class') }}"
                                           value="@if(isset($dataType->model_name)){{ $dataType->model_name }}@else{{ $model_name }}@endif">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="controller">{{ __('versatile::bread.controller_name') }}</label>
                                    <span class="versatile-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('versatile::bread.controller_name_hint') }}"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="{{ __('versatile::bread.controller_name') }}"
                                           value="@if(isset($dataType->controller)){{ $dataType->controller }}@endif">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="policy_name">{{ __('versatile::bread.policy_name') }}</label>
                                    <span class="versatile-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('versatile::bread.policy_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="{{ __('versatile::bread.policy_class') }}"
                                           value="@if(isset($dataType->policy_name)){{ $dataType->policy_name }}@endif">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="generate_permissions">{{ __('versatile::bread.generate_permissions') }}</label><br>
                                    ...
                                    <input type="checkbox" name="generate_permissions" class="toggleswitch" data-on="{{ __('versatile::generic.yes') }}" data-off="{{ __('versatile::generic.no') }}"
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="order_column">{{ __('versatile::bread.order_column') }}</label>
                                    <span class="versatile-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('versatile::bread.order_column_ph') }}"></span>
                                    <select name="order_column" class="select2 form-control">
                                          <option value="">-- {{ __('versatile::generic.none') }} --</option>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="order_display_column">{{ __('versatile::bread.order_ident_column') }}</label>
                                    <span class="versatile-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('versatile::bread.order_ident_column_ph') }}"></span>
                            ...
                            <div class="form-group">
                                <label for="description">{{ __('versatile::bread.description') }}</label>
                                <textarea class="form-control" name="description"
                                          placeholder="{{ __('versatile::bread.description') }}"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="versatile-window-list"></i> {{ __('versatile::bread.edit_rows', ['table' => $table]) }}:</h3>
                            <div class="panel-actions">
                                <a class="panel-action versatile-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                <div class="col-xs-2">{{ __('versatile::database.field') }}</div>
                                <div class="col-xs-2">{{ __('versatile::database.visibility') }}</div>
                                <div class="col-xs-2">{{ __('versatile::database.input_type') }}</div>
                                <div class="col-xs-2">{{ __('versatile::bread.display_name') }}</div>
                                <div class="col-xs-4">{{ __('versatile::database.optional_details') }}</div>
                            </div>
                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                @if(isset($dataType->id))
                                    <?php $dataRow = Versatile\Core\Models\DataRow::where('data_type_id', '=',
                                ...
                                <div class="row row-dd">
                                    <div class="col-xs-2">
                                        ...
                                        <strong>{{ __('versatile::database.type') }}:</strong> <span>{{ $data['type'] }}</span><br/>
                                        <strong>{{ __('versatile::database.key') }}:</strong> <span>{{ $data['key'] }}</span><br/>
                                        <strong>{{ __('versatile::generic.required') }}:</strong>
                                        @if($data['null'] == "NO")
                                            <span>{{ __('versatile::generic.yes') }}</span>
                                            <input type="hidden" value="1" name="field_required_{{ $data['field'] }}"
                                                   checked="checked">
                                        @else
                                            <span>{{ __('versatile::generic.no') }}</span>
                                            <input type="hidden" value="0" name="field_required_{{ $data['field'] }}">
                                        @endif
                                        <div class="handler versatile-handle"></div>
                                    ...
                                    <div class="col-xs-2">
                                        <input type="checkbox"
                                               ...
                                               @elseif(!isset($dataRow->browse))
                                                    {{ 'checked="checked"' }}
                                               @endif>
                                        <label for="field_browse_{{ $data['field'] }}">{{ __('versatile::generic.browse') }}</label><br/>
                                        ...
                                        <label for="field_read_{{ $data['field'] }}">{{ __('versatile::generic.read') }}</label><br/>
                                        ...
                                        <label for="field_edit_{{ $data['field'] }}">{{ __('versatile::generic.edit') }}</label><br/>
                                        ...
                                        <label for="field_add_{{ $data['field'] }}">{{ __('versatile::generic.add') }}</label><br/>
                                        ...
                                        <label for="field_delete_{{ $data['field'] }}">{{ __('versatile::generic.delete') }}</label><br/>
                                        ...
                                        <label for="field_filter_{{ $data['field'] }}">{{ __('versatile::generic.filter') }}</label><br/>
                                        {{-- sdkfjdlksfASAS --}}
                            ...
                            @if(isset($dataTypeRelationships))
                                @foreach($dataTypeRelationships as $relationship)
                                    @include('versatile::tools.bread.relationship-partial', $relationship)
                                @endforeach
                            @endif
                        ...
                        <div class="panel-footer">
                             <div class="btn btn-new-relationship"><i class="versatile-heart"></i> <span>
                             {{ __('versatile::database.relationship.create') }}</span></div>
                        </div>
                    </div><!-- .panel -->

                    <button type="submit" class="btn pull-right btn-primary">{{ __('versatile::generic.save') }}</button>
...
@include('versatile::tools.bread.relationship-new-modal')
...
@section('javascript')
    ...
    <script>
            ...
            $('textarea[data-editor]').each(function () {
                ...
                textarea.closest('form').on('submit', function (ev) {
                    if (window.invalidEditors.length) {
                        ...
                        toastr.error('{{ __('versatile::json.invalid_message') }}', '{{ __('versatile::json.validation_errors') }}', {"preventDuplicates": true, "preventOpenDuplicates": true});
                    } else {
       ...
       $(function () {
            ...
            $('.versatile-relationship-details-btn').click(function(){
                $(this).toggleClass('open');
                if($(this).hasClass('open')){
                    $(this).parent().parent().find('.versatile-relationship-details').slideDown();
                } else {
                    $(this).parent().parent().find('.versatile-relationship-details').slideUp();
                }
            });
        ...
        function populateRowsFromTable(dropdown){
            ...
            if(tbl.length != 0){
                $.get('{{ route('versatile.database.index') }}/' + tbl, function(data){
                    $(dropdown).empty();
