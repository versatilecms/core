...
@php
    ...
    if (Versatile::translatable($items)) {
...
@foreach ($items as $item)
    ...
    @php
        ...
        $originalItem = $item;
        if (Versatile::translatable($item)) {
    ...
    <li class="{{ $listItemClass }}">
        ...
        @if(!$originalItem->children->isEmpty())
        @include('versatile::menu.bootstrap', ['items' => $originalItem->children, 'options' => $options, 'innerLoop' => true])
        @endif
    </li>
@endforeach
