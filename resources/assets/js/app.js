...
require('./versatile_tinymce');
require('./versatile_ace_editor');
...
$(document).ready(function () {
    ...
    $(".hamburger, .navbar-expand-toggle").on('click', function () {
        ...
        if ($(this).hasClass('is-active')) {
            window.localStorage.setItem('versatile.stickySidebar', true);
        } else {
            window.localStorage.setItem('versatile.stickySidebar', false);
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-collapse"]', function (e) {
        ...
        if (!$this.hasClass('panel-collapsed')) {
            ...
            $this.removeClass('versatile-angle-up').addClass('versatile-angle-down');
        } else {
            $this.parents('.panel').find('.panel-body').slideDown();
            $this.removeClass('panel-collapsed');
            $this.removeClass('versatile-angle-down').addClass('versatile-angle-up');
        }
    });
    ...
    $(document).on('click', '.panel-heading a.panel-action[data-toggle="panel-fullscreen"]', function (e) {
        e.preventDefault();
        var $this = $(this);
        if (!$this.hasClass('versatile-resize-full')) {
            $this.removeClass('versatile-resize-small').addClass('versatile-resize-full');
        } else {
            $this.removeClass('versatile-resize-full').addClass('versatile-resize-small');
        }
