...
return [
    'welcome'                => 'Welcome to the Versatile Compass. Every good app needs a compass to point them in the right direction.
    ...
    'links'         => [
        ...
        'versatile_homepage'      => 'Versatile Homepage',
        'versatile_hooks'         => 'Versatile Hooks',
    ],
    'commands'      => [
        'title'                 => 'Commands',
        'text'                  => 'Run Artisan Commands from Versatile.',
    ...
    'resources'     => [
        'title'                 => 'Resources',
        'text'                  => 'Versatile resources to help you find things quicker.',
    ...
    'fonts'         => [
        'title'                 => 'Fonts',
        'font_class'            => 'Versatile Fonts Class Mapping',
        'font_character'        => 'Versatile Fonts Character Mapping',
    ],
];
